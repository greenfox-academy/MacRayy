class Person(object):
    def __init__(self, name = "Jane Doe", age = 0, gender = "female"):
        self.name = name
        self.age = age
        self.gender = gender
...
class Student(Person):
    def __init__(self, name = "Jane Doe", age = 0, gender = "female", previous_organization = "Life", skipped_days = 0):
...
class Mentor(Person):
    def __init__(self, name = "Jane Doe", age = 0, gender = "female", level = "junior"):
        super().__init__(name, age, gender)
        self.level = level
...
class Sponsor(Person):
    def __init__(self, name = "Jane Doe", age = 0, gender = "female", company = "Google", hired_students = 0):
        super().__init__(name, age, gender)
